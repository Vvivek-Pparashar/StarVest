const Data = [
...

  {
    ...
    Ans: "The platform is solemnly designed keeping in mind the dignity that every single startup firm deserves , the recognition a company needs as per its potential is extremely essential therefore the reviews posted by the users not only increases the online reputation but also strengthens the company's credibility. Opinions shared by public put forward a great opportunity to connect online with users and build trust, which is an important component of any successful business. In order to arrive at an appreciable position it is extremely crucial to withstand the expectations of public which is well offered by starvest  .",
    Open: false,
    Index: 2,
  },
